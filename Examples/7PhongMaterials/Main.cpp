...
int main(int argc, char** argv)
{
    ...
    Cm::Texture containerDiffuseMap(RESOURCE_DIR "/ContainerDiffuse.png", Cm::TextureFilter::Nearest);
    Cm::Texture containerSpecularMap(RESOURCE_DIR "/ContainerSpecular.png", Cm::TextureFilter::Nearest);
